    ...
    <View  className="flex-1 justify-center items-center bg-[#FFFCEF] " >
       <View className="bg-[#FFFCEF] p-5 rounded-lg w-[90%]">
         <Text className="text-[28px] font-bold text-center m-[6px]">
          ...
          Forgot password? input your email and check reset code from your email.
        </Text>
        {done == true ? (
      <View>
            <Text className="justify-center text-center bg-transparent justify-items-center mt-5 mb-2 border-none rounded-xl w-full">{email}</Text>
            ...
            autoCapitalize="none"
            onChangeText={(text) => setEmail(text)} /><Button
              className="grid"
      ...
      {done && (
        ...
        <View className="flex-row justify-between mb-4">
         ...
         secureTextEntry={!showConfirmPassword}
          ...
          <Button style={tw`bg-[#DFC4A4] rounded-md mb-3`}
          labelStyle={tw`text-[#4f3a3a] text-[13px]`} onPress={changePassword}>Submit</Button>
        </View>
